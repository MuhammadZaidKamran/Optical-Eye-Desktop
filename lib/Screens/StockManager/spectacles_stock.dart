...
class SpectaclesStock extends StatefulWidget {
  const SpectaclesStock({super.key});

  @override
  State<SpectaclesStock> createState() => _SpectaclesStockState();
}

class _SpectaclesStockState extends State<SpectaclesStock> {
